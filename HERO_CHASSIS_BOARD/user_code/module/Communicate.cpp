...
void Communicate::run()
{
    ...
    //cap.cap_read_data(can_receive.cap_receive.cap_vot, can_receive.cap_receive.cap_percentage, can_receive.cap_receive.cap_mode, can_receive.cap_receive.bat_vot);
